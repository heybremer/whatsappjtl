...
{if $enabled == 'Y'}
    ...
    {assign var=label value=$oPlugin->oPluginEinstellungAssoc_arr.button_label}
    ...
    <div id="wa-floating-button"
         data-wa-phone="{$phone|escape}"
         data-wa-message="{$msg|escape}"
         data-wa-label="{$label|escape}"></div>
{/if}
